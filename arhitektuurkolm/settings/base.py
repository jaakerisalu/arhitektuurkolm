"""
Django settings for Arhitektuur kolm project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Arhitektuur kolm] '  # subject prefix for managers & admins
...
ROOT_URLCONF = 'arhitektuurkolm.urls'

WSGI_APPLICATION = 'arhitektuurkolm.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Arhitektuur kolm <info@TODO.com>"
SERVER_EMAIL = "Arhitektuur kolm server <server@TODO.com>"
